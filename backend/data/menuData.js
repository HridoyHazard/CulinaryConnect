    ...
    items: [
      {
        name: "Steak",
        description:
          "A juicy grilled steak served with garlic mashed potatoes and seasonal vegetables.",
        price: 18.99,
        image:
      ...
      },
      {
        ...
        description:
          "Tender grilled chicken breast marinated in herbs and spices.",
        price: 15.49,
        image:
    ...
    items: [
      {
        ...
        description:
          "A delicious assortment of mini spring rolls, chicken wings, and mozzarella sticks.",
        price: 10.99,
        image:
      ...
      },
      {
        name: "Bruschetta",
        description:
          "Toasted baguette slices topped with fresh tomatoes, basil, and balsamic glaze.",
        price: 7.49,
        image:
    ...
    items: [
      {
        ...
        description:
          "Classic spaghetti with creamy carbonara sauce, bacon, and parmesan cheese.",
        price: 12.99,
        image:
      ...
      },
      {
        ...
        description:
          "Penne pasta tossed with fresh vegetables in a light olive oil and garlic sauce.",
        price: 11.99,
        image:
          "https://res.cloudinary.com/dfyewpdn8/image/upload/v1742021720/Culinary/dinner/exkjqms1b2mxccffihtn.png",
      },
      {
        name: "Chicken Alfredo",
        description:
          "Grilled chicken and fettuccine pasta in a rich alfredo sauce.",
        price: 13.99,
        image:
    ...
    items: [
      {
        ...
        price: 9.99,
        image:
          "https://res.cloudinary.com/dfyewpdn8/image/upload/v1742021720/Culinary/dinner/k38cfskmfe8anjt61poc.png",
      },
      {
        name: "Greek Salad",
        description:
          "Fresh cucumbers, tomatoes, olives, and feta cheese with Greek vinaigrette.",
        price: 8.49,
        image:
      ...
      },
      {
        name: "Caprese Salad",
        description:
          "Slices of ripe tomatoes, fresh mozzarella, and basil with balsamic glaze.",
        price: 7.99,
        image:
